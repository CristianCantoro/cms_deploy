...
* CMS `v1.4.rc1` - latest stable release, released in November 2018.
* CMS `v1.3.1` - released in April 2018
* CMS `v1.3.0` - released in March 2018
* CMS `v1.3.rc0` - released in March 2017
* CMS `v1.2.0` - released in Febraury 2015
